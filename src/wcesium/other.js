...
function addNav(viewer) {
  var options = {
    ...
    defaultResetView: new Rectangle.fromDegrees(111.339523, 33.231447, 112.838902, 35.100877),
...
function moveGetInfo(viewer, callback) {
  mouseMove(viewer, function (cartographic) {
    let cityLng = Math.toDegrees(cartographic.longitude);
    let cityLat = Math.toDegrees(cartographic.latitude);
